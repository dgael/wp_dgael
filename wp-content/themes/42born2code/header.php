...
<div id="header">
	<div class="pads clearfix">
		...
		{
			echo "<a href=\"/wp-login.php?action=logout&_wpnonce=8102d8c9ca\">Se d&eacuteconnecter</a><br />";
		}
		else
		{
			echo "<a href=\"/wp-login.php\">Acc&egraves candidat</a><br />";
			echo "PRÉINSCRIS-TOI<br />";
			echo "Tu envisages de devenir un 42 à la rentrée ? Alors tente le coup et préinscris-toi ici.<br />";
			echo "<form method=\"post\" action=\"/wp-login.php?action=register\">";
			echo "Login : <input type=\"text\" name=\"user_login\" value size=\"20\"><br />";
			echo "Email : <input type=\"text\" name=\"user_email\" value size=\"25\"><br />";
			echo "<input type=\"submit\" name=\"wp-submit\" value=\"Born to code!\"><br />";
			echo "</form>";
		} ?>
		<div class="nav-wrap">
			<div id="nav">
